...
public class VistaRequerimientosReto4 extends JFrame{
    ...
    public VistaRequerimientosReto4(){
        ...
        contentPane.setBorder(new EmptyBorder(8,5,5,8));
        setContentPane(contentPane);
        contentPane.setLayout(null);

        JLabel lbltitulo = new JLabel("**Reto 5**");
        lbltitulo.setBounds(30, 20, 61, 16);
        contentPane.add(lbltitulo);

        JLabel lblautor = new JLabel("**Jorge Armando Herrera Rozo**");
        lblautor.setBounds(30, 50, 208, 16);
        contentPane.add(lblautor);

        JScrollPane scrollPane = new JScrollPane();
        scrollPane.setBounds(28, 100, 730, 350);
        contentPane.add(scrollPane);

        textArea = new JTextArea();
        scrollPane.setViewportView(textArea);

        JButton btnConsuta1 = new JButton("Boton #1");
        ...
        btnConsuta1.setBounds(30, 460, 117, 29);
        contentPane.add(btnConsuta1);

        JButton btnConsuta2 = new JButton("Boton #2");
        ...
        btnConsuta2.setBounds(157, 460, 117, 29);
        contentPane.add(btnConsuta2);

        JButton btnConsuta3 = new JButton("Boton #3");
        ...
        btnConsuta3.setBounds(286, 460, 117, 29);
        ...
        btnLimpiar.setBounds(648, 460, 117, 29);
